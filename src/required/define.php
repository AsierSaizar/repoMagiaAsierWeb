...
//Ubuntu
define('APP_DIR', $_SERVER['DOCUMENT_ROOT'] . '/repoMagiaAsierWeb'); //Aplikazioaren karpeta edozein lekutatik atzitzeko.
define('HREF_VIEWS_DIR', '/repoMagiaAsierWeb/src/views'); //Aplikazioaren views karpeta edozein lekutatik deitzeko
define('HREF_SRC_DIR', '/repoMagiaAsierWeb/src'); //Aplikazioaren views karpeta edozein lekutatik deitzeko
