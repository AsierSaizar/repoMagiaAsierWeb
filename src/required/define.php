...
//Ubuntu raspberry PI
//define('APP_DIR', $_SERVER['DOCUMENT_ROOT'] . '/repoMagiaAsier'); //Aplikazioaren karpeta edozein lekutatik atzitzeko.
//define('HREF_VIEWS_DIR', '/repoMagiaAsier/src/views'); //Aplikazioaren views karpeta edozein lekutatik deitzeko
//define('HREF_SRC_DIR', '/repoMagiaAsier/src'); //Aplikazioaren views karpeta edozein lekutatik deitzeko
